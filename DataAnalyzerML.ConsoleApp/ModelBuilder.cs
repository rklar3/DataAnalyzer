...
namespace DataAnalyzerML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\devbox1952\Downloads\audits2.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\devbox1952\AppData\Local\Temp\MLVSTools\DataAnalyzerML\DataAnalyzerML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotHashEncoding(new[] { new InputOutputColumnPair("URL", "URL"), new InputOutputColumnPair("LocalPath", "LocalPath") })
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "URL", "LocalPath" }))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);
            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "Risk", numberOfIterations: 10, featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "Risk");
